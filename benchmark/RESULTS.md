...
> **SUPERSEDED BY [RESULTS_V2.md](RESULTS_V2.md).** This document records the
> v1 measurement (n=56, 1123-chunk corpus) and remains accurate for that
> corpus and query set. v2 expands to 93 queries and 1222 chunks, and
> **reverses two conclusions below**: Bucket 2's "ceiling effect" was
> substantially an artifact of file-level ground truth, and the `final_k=8`
> result does not survive an equal-budget comparison against dense-only@8.
